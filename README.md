...
- All pages are protected with an auth guard in `js/app.js` — unauthenticated users are redirected to `login.html`
...
- Stock is re-validated server-side before committing checkout
